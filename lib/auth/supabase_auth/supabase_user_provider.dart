...
class SupabaseFlutterFlowSpeedrunSupabaseUser extends BaseAuthUser {
  SupabaseFlutterFlowSpeedrunSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> supabaseFlutterFlowSpeedrunSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          SupabaseFlutterFlowSpeedrunSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
